...
void loop()
{
  ...
  display.clearDisplay();
  display.setCursor(0, 0);
  display.println(F("accel (x y z)"));
  display.print(accel_t_gyro.value.x_accel);
  display.print(F(" "));
  display.print(accel_t_gyro.value.y_accel);
  display.print(F(" "));
  display.println(accel_t_gyro.value.z_accel);
  ...
  display.println(F("gyro (x y z)"));
  display.print(accel_t_gyro.value.x_gyro);
  display.print(F(" "));
  display.print(accel_t_gyro.value.y_gyro);
  display.print(F(" "));
  display.print(accel_t_gyro.value.z_gyro);
  display.display();
  delay(10);
}
